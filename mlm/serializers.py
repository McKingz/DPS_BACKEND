...
from .models import User, Referral, Commission, RecentActivity, Activity, Commission, UserProfile
...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ('id', 'username', 'email', 'first_name', 'last_name', 'phone_number', 'password', 'referral_code', 'referred_by', 'earnings', 'total_sales', 'profile_picture', 'total_referrals')
...
class UserProfileSerializer(serializers.ModelSerializer):
    class Meta:
        model = UserProfile
        fields = ['username', 'phone_number', 'email_address', 'profile_picture']
